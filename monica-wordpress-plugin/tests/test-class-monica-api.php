...
class Test_Class_Monica_Api {
    ...
    public function test_get_authorization_url_with_valid_params() {
        ...
        $expected = 'https://app.monicahq.com/oauth/authorize?client_id=test_client_id&redirect_uri=https%3A%2F%2Fexample.com%2Fcallback&response_type=code';
    ...
    public function test_get_authorization_url_with_missing_client_id() {
        ...
        $expected = 'https://app.monicahq.com/oauth/authorize?client_id=0&redirect_uri=https%3A%2F%2Fexample.com%2Fcallback&response_type=code';
    ...
    public function test_get_authorization_url_encodes_redirect_uri() {
        ...
        $expected = "https://app.monicahq.com/oauth/authorize?client_id=test_client_id&redirect_uri=$encoded_uri&response_type=code";
