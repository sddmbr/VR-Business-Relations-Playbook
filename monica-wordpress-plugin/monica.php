...
function monica_integration_add_reminder() {
    if ( isset( $_POST['monica_add_reminder'], $_POST['monica_add_reminder_nonce'] ) ) {
        if ( ! wp_verify_nonce( $_POST['monica_add_reminder_nonce'], 'monica_add_reminder' ) ) {
            return;
        }

        $post_id = (int) ( $_POST['monica_post_id'] ?? 0 );
...
function monica_integration_add_note() {
    if ( isset( $_POST['monica_add_note'], $_POST['monica_add_note_nonce'] ) ) {
...
function monica_integration_add_relationship() {
    if ( isset( $_POST['monica_add_relationship'], $_POST['monica_add_relationship_nonce'] ) ) {
